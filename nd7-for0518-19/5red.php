...
if (isset($_GET['redir']) && $_GET['redir'] == 1){
    header('Location: http://localhost/assignments/nd7-for0518/5blue.php');
    die;
}
?>

<body style = "background-color: red">
<a href = http://localhost/assignments/nd7-for0518/5red.php?redir=1 style = "color: blue">Nuoroda</a>
</body>